...
<div class="main_content">
	...
	<div id="content">
			...
			<br> -->
	  <h3> Please use our IRC channel to chat with the moderators of the event. You can use any other IRC client as well. Join us on #nitdgplug at Freenode. </h3>
	  <iframe src="http://webchat.freenode.net/?channels=nitdgplug" width="750" height="500"></iframe>
	  </div>

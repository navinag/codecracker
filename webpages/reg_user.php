...
if($flag==0)
{
	echo "<center><h3>Error 203: Username/email-id already exists.<br> Please <a href=\"register.php?t="; echo $t; echo "\">Register</a> again with a different username/email-id!!!</h3></center>";
}
...
if($flag)
{
	$query = "insert into user
        	...
        	('$fname','$lname','$sex','$college','$roll','$dept','$year','$email','$mobile','$username','$passwd','$username',' ')";
	$result = stripSlashes($query);
